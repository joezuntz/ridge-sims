...
def run_analysis(case_label, shear_csv, noise_files, plot_dir, plot_suffix=""):
    ...
    plt.figure(figsize=(7.5, 5.2))
    plt.errorbar(
        arcmin_centers, g_plus_sub, yerr=g_plus_noise_std,
    ...
    plt.figure(figsize=(7.5, 5.2))
    plt.errorbar(
        arcmin_centers, g_cross_sub, yerr=g_cross_noise_std,
...
if __name__ == "__main__":
    ...
    noise_files = sorted(glob.glob(os.path.join(target_dir, "random_rotations", "shear_random_*.csv")))
