...
csv_file = os.path.join(current_dir, "shear_hybrid_DES_update/run_1/band_0.1/mesh_2/run_1_p15_signal_shear.csv")
out_png  = os.path.join(current_dir, "shear_hybrid_DES_update", "gamma_plus_DES_hybrid.png")
