...
def filaments(coordinates, 
    ...
    if bandwidth is None:
        raise ValueError("You now have to calculate the bandwidth externally")
    ...
    if comm is not None:
        # Broadcast the tree to all processes
    ...
    while points_to_update.sum() > 0:
        ...
        if checkpoint_dir is not None:
            checkpoint(checkpoint_dir, iteration_number, full_ridges, comm)
    ...
    return full_ridges, initial_density, final_density
