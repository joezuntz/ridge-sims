...
csv_file2 = os.path.join(current_dir, "density_threshold_test/shear_vs_threshold/run_1_shear_fp_15.csv")
...
out_png   = os.path.join(current_dir, "density_threshold_test", "gamma_plus_p_40_new.png")
