# This is a temporary script to run all the missing cosmologies
...
# =====================================
# Only run these missing combinations 
# =====================================
...
def run_cosmology(category, run_idx):
    ...
    config = Config(
        ...
        sim_dir=sim_dir,
        seed=run_idx,
        include_shape_noise=False  # noise off
    )
    config.save()
...
if __name__ == "__main__":
    ...
    # ============================================================
    # Skip all jobs NOT in the missing list
    # ============================================================
    if (category, run_idx) not in MISSING:
        print(f"Skipping {category}/run_{run_idx+1} (not in missing set).")
        sys.exit(0)

    # Run the selected missing job
