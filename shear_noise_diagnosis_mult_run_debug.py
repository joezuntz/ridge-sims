...
# Config
# ------------------------
base_root = "simulation_ridges_comparative_analysis_debug"   # Base folder: zero_err/normal folders
noise_dir = "simulation_ridges_comparative_analysis_debug/noise"  # Noise realizations folder
