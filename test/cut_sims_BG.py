...
# Loop over both base simulation directories
for base_sim_dir in ["lhc_run_sims_zero_err_10", "lhc_run_sims_with_err_10"]:
    print(f"\n=== Processing simulations in: {base_sim_dir} ===")

    for run_id in range(1, 10):  # runs 1 through 9
        bg_data_path = os.path.join(base_sim_dir, f"run_{run_id}", "source_catalog_0.h5")
